...
Optional `stroke-width` (stroke-style libraries only — e.g. lucide/tabler-outline):
    Default 2 (matches the source). Pass 1.5 for thin, 2.25 for slightly stronger, 3 for bold.
...
Icon libraries (subdirectories of templates/icons/):
    ...
    lucide/            - stroke icons, 24x24 viewBox (use prefix: lucide/name; recommended default for generic icons)

    ...
    def test_workflow_builds_plan_gallery_and_pptx(self):
        ...
        with self.subTest("temporary output"):
            ...
            with tempfile.TemporaryDirectory() as tmp:
                ...
                self.assertTrue((tmp_path / "workflow" / "component_gallery.pptx").exists())
        ...
        self.assertEqual(report["pptx_status"], "pass")
        self.assertEqual(component_plan["slides"][0]["selected_assets"][0]["asset_id"], "component_package/kpi_row_3")
        self.assertEqual(component_plan["slides"][1]["selected_assets"][0]["asset_id"], "component_package/evidence_stack")

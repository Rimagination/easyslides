...
python3 scripts/notes_to_audio.py <project_path> \
...
- (If skipped embedding) one-line hint on how to embed later: `python3 scripts/svg_to_pptx.py <project_path> --recorded-narration audio`.

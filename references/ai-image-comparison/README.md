...
python3 scripts/image_gen.py \
    --manifest references/ai-image-comparison/rendering/_manifest.json \
    -o references/ai-image-comparison/rendering/ \
    --backend openai

python3 scripts/image_gen.py \
    --manifest references/ai-image-comparison/palette/_manifest.json \
    -o references/ai-image-comparison/palette/ \
    --backend openai

python3 scripts/image_gen.py \
    --manifest references/ai-image-comparison/type/_manifest.json \
    -o references/ai-image-comparison/type/ \
    --backend openai
```

...
- **Built-in icon library**: `templates/icons/` (11,600+ icons across six libraries; prefer `lucide` for new generic icons and emoji replacement; see `templates/icons/README.md`)
